      ...
      <PageSection>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(360px, 0.9fr)', gap: 44, alignItems: 'center' }} className="tdn-grid">
          <div>
            ...
            <h1 style={styles.h1}>3dnavigate by Vrrrt.</h1>
            <p style={styles.copy}>A storefront product discovery cube for Shopify merchants who want shoppers to browse collections by moving through a visual 3D interface.</p>
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 30 }}>
              <a className="tdn-btn tdn-btn-primary" href="/3dnavigate/setup">Setup guide</a>
  ...
  return (
    <Shell active="setup">
      <PageSection>
        ...
        <p style={styles.copy}>3dnavigate is installed as a Shopify theme app block. Merchants control placement and product groups in the Shopify theme editor.</p>
      </PageSection>
      <PageSection>
...
function Support() {
  const cards = [
    ...
    ['Common fix', 'If the cube is not visible, confirm the 3dnavigate Cube app block is added and the theme is saved.'],
  ];
  return (
    <Shell active="support">
      <PageSection>
        <div style={styles.eyebrow}>Support</div>
        <h1 style={styles.h1}>Help with 3dnavigate.</h1>
...
const legalDocs = {
  privacy: {
    active: 'privacy',
    kind: '3dnavigate by Vrrrt',
    title: 'Privacy Policy',
    intro: 'This policy explains what information 3dnavigate uses to provide the Shopify storefront cube.',
    sections: [
      ['Information we use', '3dnavigate uses Shopify product and collection information that a merchant makes available to the app, including product titles, images, prices, availability, vendors, product types, tags, and product links.', 'The app may receive store-identifying information needed to install, authenticate, and operate the Shopify app.'],
      ['Shopper data', '3dnavigate does not require shoppers to create an account with Vrrrt and does not intentionally collect payment card details. Add-to-cart actions are handled through Shopify storefront cart endpoints.'],
  ...
  terms: {
    ...
    intro: 'These terms apply to use of 3dnavigate by Vrrrt, a Shopify product discovery app.',
    sections: [
      ['Use of the app', '3dnavigate is provided for Shopify merchants to display products in an interactive storefront cube. Merchants are responsible for configuring the app block, product groups, theme placement, and storefront content.'],
      ...
      ['Acceptable use', 'Merchants may not use 3dnavigate to violate laws, infringe rights, distribute harmful content, or interfere with Shopify, Vrrrt, or other merchants.'],
